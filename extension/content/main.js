...
const addTypefullyOne = () => {
  ...
  if (tweetTextAreaOne && !document.getElementById("typefully-link")) {
    ...
    typefullyLogo.innerHTML = `<svg width="21" height="21" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<circle cx="82.5" cy="107.5" r="8.5" fill="#1DA1F2"/>
    ...
    const typefullyTextStart = document.createElement("span");
    typefullyTextStart.innerText = "Continue thread in";
    const typefullyTextEnd = document.createElement("span");
    typefullyTextEnd.innerText = "Typefully";

    typefullyLink.appendChild(typefullyTextStart);
    typefullyLink.appendChild(typefullyLogo);
    typefullyLink.appendChild(typefullyTextEnd);
