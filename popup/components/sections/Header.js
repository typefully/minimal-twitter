...
const Header = () => (
  <header className="text-center">
    <div className="flex items-center justify-center">
      ...
      >
        <svg className="fill-xPremium" viewBox="0 0 24 24" width={20} height={20} aria-hidden="true">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="absolute text-sm font-semibold text-xPremium right-4"
    ...
    <p className="pt-3 pb-3 text-sm font-medium leading-5 dark:text-twitterAccentOneDark text-twitterAccentOne">
      ...
      <a href="https://typefully.com/?ref=minimal-twitter" target="_blank" rel="noreferrer" className="text-xPremium hover:underline font-bold cursor-pointer ml-1">
        <TypefullyGlyph />
        Typefully
      </a>
    </p>
