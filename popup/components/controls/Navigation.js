...
const Communities = () => (
  <UserButton storageKey="communitiesButton" defaultState={false}>
    <path
      className="fill-current"
...
const Lists = () => (
  <UserButton storageKey="listsButton" defaultState={false}>
    <path
      className="fill-current"
...
const TwitterBlue = () => (
  <UserButton storageKey="twitterBlueButton" defaultState={false}>
    <path
      className="fill-current"
